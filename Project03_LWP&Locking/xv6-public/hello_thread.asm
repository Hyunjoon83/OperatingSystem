 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 40 07 00 00 	jmp    *0x740(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 38 07 00 00       	mov    $0x738,%edx
        while(*s != 0){
 ...
 5a1:	a1 40 0a 00 00       	mov    0xa40,%eax
{
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 40 0a 00 00    	mov    %edx,0xa40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 40 0a 00 00    	mov    0xa40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 40 0a 00 00    	mov    0xa40,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 44 0a 00 00       	mov    $0xa44,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 712:	00 00 00 
    if(p->s.size >= nunits){
