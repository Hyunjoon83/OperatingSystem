...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 67 82 10 80 	movl   $0x80108267,(%esp)
...
80100ac4:	ff 70 10             	push   0x10(%eax)
  struct proc *curproc = myproc();
80100ac7:	89 85 ec fe ff ff    	mov    %eax,-0x114(%ebp)
  kill_threads(curproc->pid); // 나머지 thread를 종료
80100acd:	e8 9e 37 00 00       	call   80104270 <kill_threads>

  begin_op();
80100ad2:	e8 89 22 00 00       	call   80102d60 <begin_op>

  if((ip = namei(path)) == 0){
80100ad7:	5a                   	pop    %edx
80100ad8:	ff 75 08             	push   0x8(%ebp)
80100adb:	e8 c0 15 00 00       	call   801020a0 <namei>
80100ae0:	83 c4 10             	add    $0x10,%esp
80100ae3:	85 c0                	test   %eax,%eax
80100ae5:	0f 84 f9 02 00 00    	je     80100de4 <exec+0x334>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
  ilock(ip);
80100aeb:	83 ec 0c             	sub    $0xc,%esp
80100aee:	89 c3                	mov    %eax,%ebx
80100af0:	50                   	push   %eax
80100af1:	e8 8a 0c 00 00       	call   80101780 <ilock>
  pgdir = 0;

  // Check ELF header
  if(readi(ip, (char*)&elf, 0, sizeof(elf)) != sizeof(elf))
80100af6:	8d 85 24 ff ff ff    	lea    -0xdc(%ebp),%eax
80100afc:	6a 34                	push   $0x34
80100afe:	6a 00                	push   $0x0
80100b00:	50                   	push   %eax
80100b01:	53                   	push   %ebx
80100b02:	e8 89 0f 00 00       	call   80101a90 <readi>
80100b07:	83 c4 20             	add    $0x20,%esp
80100b0a:	83 f8 34             	cmp    $0x34,%eax
80100b0d:	74 21                	je     80100b30 <exec+0x80>
...
80100b12:	53                   	push   %ebx
80100b13:	e8 f8 0e 00 00       	call   80101a10 <iunlockput>
    end_op();
80100b18:	e8 b3 22 00 00       	call   80102dd0 <end_op>
80100b1d:	83 c4 10             	add    $0x10,%esp
  }
  return -1;
80100b20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80100b25:	8d 65 f4             	lea    -0xc(%ebp),%esp
80100b28:	5b                   	pop    %ebx
80100b29:	5e                   	pop    %esi
80100b2a:	5f                   	pop    %edi
80100b2b:	5d                   	pop    %ebp
...
80100b37:	45 4c 46 
80100b3a:	75 d3                	jne    80100b0f <exec+0x5f>
  if((pgdir = setupkvm()) == 0)
80100b3c:	e8 cf 69 00 00       	call   80107510 <setupkvm>
80100b41:	89 85 f4 fe ff ff    	mov    %eax,-0x10c(%ebp)
80100b47:	85 c0                	test   %eax,%eax
80100b49:	74 c4                	je     80100b0f <exec+0x5f>
...
80100ba3:	e8 88 67 00 00       	call   80107330 <allocuvm>
...
80100bd9:	e8 62 66 00 00       	call   80107240 <loaduvm>
...
80100c1b:	e8 70 68 00 00       	call   80107490 <freevm>
  if(ip){
80100c20:	83 c4 10             	add    $0x10,%esp
80100c23:	e9 e7 fe ff ff       	jmp    80100b0f <exec+0x5f>
...
80100c62:	e8 c9 66 00 00       	call   80107330 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 28 69 00 00       	call   801075b0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 83 6a 00 00       	call   80107780 <copyout>
...
80100d11:	e8 7a 67 00 00       	call   80107490 <freevm>
80100d16:	83 c4 10             	add    $0x10,%esp
  return -1;
80100d19:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100d1e:	e9 02 fe ff ff       	jmp    80100b25 <exec+0x75>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 18 6a 00 00       	call   80107780 <copyout>
...
80100dcd:	e8 de 62 00 00       	call   801070b0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 b6 66 00 00       	call   80107490 <freevm>
  return 0;
80100dda:	83 c4 10             	add    $0x10,%esp
80100ddd:	31 c0                	xor    %eax,%eax
80100ddf:	e9 41 fd ff ff       	jmp    80100b25 <exec+0x75>
    end_op();
...
80100dfe:	e9 22 fd ff ff       	jmp    80100b25 <exec+0x75>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
...
80102088:	68 4e 80 10 80       	push   $0x8010804e
...
801024d2:	81 fb d0 a4 11 80    	cmp    $0x8011a4d0,%ebx
...
80103022:	e8 89 2f 00 00       	call   80105fb0 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 55 40 00 00       	call   801070a0 <switchkvm>
  seginit();
8010304b:	e8 c0 3f 00 00       	call   80107010 <seginit>
  lapicinit();
...
80103077:	68 d0 a4 11 80       	push   $0x8011a4d0
8010307c:	e8 8f f5 ff ff       	call   80102610 <kinit1>
  kvmalloc();      // kernel page table
80103081:	e8 0a 45 00 00       	call   80107590 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 7b 3f 00 00       	call   80107010 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 f7 31 00 00       	call   801062a0 <uartinit>
  pinit();         // process table
801030a9:	e8 72 08 00 00       	call   80103920 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 7d 2e 00 00       	call   80105f30 <tvinit>
  binit();         // buffer cache
...
801037b0:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801037b5:	eb 17                	jmp    801037ce <wakeup1+0x1e>
801037b7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801037be:	66 90                	xchg   %ax,%ax
801037c0:	81 c2 7c 01 00 00    	add    $0x17c,%edx
801037c6:	81 fa 54 8c 11 80    	cmp    $0x80118c54,%edx
801037cc:	74 20                	je     801037ee <wakeup1+0x3e>
    if(p->state == SLEEPING && p->chan == chan)
801037ce:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
801037d2:	75 ec                	jne    801037c0 <wakeup1+0x10>
801037d4:	39 42 20             	cmp    %eax,0x20(%edx)
801037d7:	75 e7                	jne    801037c0 <wakeup1+0x10>
      p->state = RUNNABLE;
801037d9:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037e0:	81 c2 7c 01 00 00    	add    $0x17c,%edx
801037e6:	81 fa 54 8c 11 80    	cmp    $0x80118c54,%edx
801037ec:	75 e0                	jne    801037ce <wakeup1+0x1e>
}
801037ee:	c3                   	ret    
801037ef:	90                   	nop
...
801037f3:	53                   	push   %ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037f4:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
801037f9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037fc:	68 20 2d 11 80       	push   $0x80112d20
80103801:	e8 1a 13 00 00       	call   80104b20 <acquire>
80103806:	83 c4 10             	add    $0x10,%esp
80103809:	eb 13                	jmp    8010381e <allocproc+0x2e>
8010380b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010380f:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103810:	81 c3 7c 01 00 00    	add    $0x17c,%ebx
80103816:	81 fb 54 8c 11 80    	cmp    $0x80118c54,%ebx
...
8010383f:	89 15 08 b0 10 80    	mov    %edx,0x8010b008
  release(&ptable.lock);
80103845:	e8 76 12 00 00       	call   80104ac0 <release>
  if((p->kstack = kalloc()) == 0){            // kstack에는 4096 byte의 메모리의 시작 주소가 저장됨
8010384a:	e8 31 ee ff ff       	call   80102680 <kalloc>
...
8010386a:	c7 40 14 17 5f 10 80 	movl   $0x80105f17,0x14(%eax)
...
80103879:	e8 62 13 00 00       	call   80104be0 <memset>
...
801038a2:	e8 19 12 00 00       	call   80104ac0 <release>
}
...
801038db:	e8 e0 11 00 00       	call   80104ac0 <release>
  if (first) {
...
80103926:	68 a0 7d 10 80       	push   $0x80107da0
8010392b:	68 20 2d 11 80       	push   $0x80112d20
80103930:	e8 1b 10 00 00       	call   80104950 <initlock>
}
...
801039f4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
801039f7:	e8 f4 fd ff ff       	call   801037f0 <allocproc>
801039fc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039fe:	a3 54 8c 11 80       	mov    %eax,0x80118c54
  if((p->pgdir = setupkvm()) == 0)
80103a03:	e8 08 3b 00 00       	call   80107510 <setupkvm>
...
80103a21:	e8 9a 37 00 00       	call   801071c0 <inituvm>
...
80103a8f:	68 d0 7d 10 80       	push   $0x80107dd0
80103a94:	50                   	push   %eax
80103a95:	e8 06 13 00 00       	call   80104da0 <safestrcpy>
  p->cwd = namei("/");
80103a9a:	c7 04 24 d9 7d 10 80 	movl   $0x80107dd9,(%esp)
...
80103ad3:	68 b7 7d 10 80       	push   $0x80107db7
...
80103b00:	68 20 2d 11 80       	push   $0x80112d20
80103b05:	e8 16 10 00 00       	call   80104b20 <acquire>
  sz = curproc->sz;
80103b0a:	8b 03                	mov    (%ebx),%eax
  if(n > 0){
80103b0c:	83 c4 10             	add    $0x10,%esp
80103b0f:	85 f6                	test   %esi,%esi
80103b11:	7f 2d                	jg     80103b40 <growproc+0x60>
  } else if(n < 0){
80103b13:	75 5b                	jne    80103b70 <growproc+0x90>
  release(&ptable.lock);
80103b15:	83 ec 0c             	sub    $0xc,%esp
  curproc->sz = sz;
80103b18:	89 03                	mov    %eax,(%ebx)
  release(&ptable.lock);
80103b1a:	68 20 2d 11 80       	push   $0x80112d20
80103b1f:	e8 9c 0f 00 00       	call   80104ac0 <release>
  switchuvm(curproc);
80103b24:	89 1c 24             	mov    %ebx,(%esp)
80103b27:	e8 84 35 00 00       	call   801070b0 <switchuvm>
  return 0;
80103b2c:	83 c4 10             	add    $0x10,%esp
80103b2f:	31 c0                	xor    %eax,%eax
}
80103b31:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103b34:	5b                   	pop    %ebx
80103b35:	5e                   	pop    %esi
80103b36:	5d                   	pop    %ebp
80103b37:	c3                   	ret    
...
80103b7a:	e8 e1 38 00 00       	call   80107460 <deallocuvm>
80103b7f:	83 c4 10             	add    $0x10,%esp
80103b82:	85 c0                	test   %eax,%eax
80103b84:	75 8f                	jne    80103b15 <growproc+0x35>
80103b86:	eb ce                	jmp    80103b56 <growproc+0x76>
...
80103b96:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b99:	e8 32 0e 00 00       	call   801049d0 <pushcli>
  c = mycpu();
80103b9e:	e8 9d fd ff ff       	call   80103940 <mycpu>
  p = c->proc;
80103ba3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba9:	e8 72 0e 00 00       	call   80104a20 <popcli>
  if((np = allocproc()) == 0){
80103bae:	e8 3d fc ff ff       	call   801037f0 <allocproc>
...
80103bc8:	e8 33 3a 00 00       	call   80107600 <copyuvm>
...
80103cb6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103cb9:	e8 82 fc ff ff       	call   80103940 <mycpu>
  c->proc = 0;
...
80103cde:	e8 3d 0e 00 00       	call   80104b20 <acquire>
...
80103d00:	e8 ab 33 00 00       	call   801070b0 <switchuvm>
...
80103d0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d12:	e8 e4 10 00 00       	call   80104dfb <swtch>
      switchkvm();
80103d17:	e8 84 33 00 00       	call   801070a0 <switchkvm>
      c->proc = 0;
80103d1c:	83 c4 10             	add    $0x10,%esp
80103d1f:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103d26:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d29:	81 c3 7c 01 00 00    	add    $0x17c,%ebx
80103d2f:	81 fb 54 8c 11 80    	cmp    $0x80118c54,%ebx
80103d35:	75 b9                	jne    80103cf0 <scheduler+0x40>
    release(&ptable.lock);
80103d37:	83 ec 0c             	sub    $0xc,%esp
80103d3a:	68 20 2d 11 80       	push   $0x80112d20
80103d3f:	e8 7c 0d 00 00       	call   80104ac0 <release>
    sti();
...
80103db3:	e8 43 10 00 00       	call   80104dfb <swtch>
  mycpu()->intena = intena;
...
80103e16:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103e19:	e8 a2 fb ff ff       	call   801039c0 <myproc>
  if(curproc == initproc)
80103e1e:	39 05 54 8c 11 80    	cmp    %eax,0x80118c54
80103e24:	0f 84 17 01 00 00    	je     80103f41 <exit+0x131>
  acquire(&ptable.lock);
80103e2a:	83 ec 0c             	sub    $0xc,%esp
80103e2d:	89 c3                	mov    %eax,%ebx
80103e2f:	68 20 2d 11 80       	push   $0x80112d20
80103e34:	e8 e7 0c 00 00       	call   80104b20 <acquire>
  for (int i = 0; i < NTHREAD; i++) {
80103e39:	8d 43 7c             	lea    0x7c(%ebx),%eax
80103e3c:	8d 8b 7c 01 00 00    	lea    0x17c(%ebx),%ecx
80103e42:	83 c4 10             	add    $0x10,%esp
80103e45:	8d 76 00             	lea    0x0(%esi),%esi
    if (curproc->threads[i] && curproc->threads[i]->state != T_UNUSED) {
80103e48:	8b 10                	mov    (%eax),%edx
80103e4a:	85 d2                	test   %edx,%edx
80103e4c:	74 0e                	je     80103e5c <exit+0x4c>
80103e4e:	8b 72 18             	mov    0x18(%edx),%esi
80103e51:	85 f6                	test   %esi,%esi
80103e53:	74 07                	je     80103e5c <exit+0x4c>
      curproc->threads[i]->state = T_ZOMBIE;
80103e55:	c7 42 18 05 00 00 00 	movl   $0x5,0x18(%edx)
  for (int i = 0; i < NTHREAD; i++) {
80103e5c:	83 c0 04             	add    $0x4,%eax
80103e5f:	39 c1                	cmp    %eax,%ecx
80103e61:	75 e5                	jne    80103e48 <exit+0x38>
  release(&ptable.lock);
80103e63:	83 ec 0c             	sub    $0xc,%esp
80103e66:	8d 73 28             	lea    0x28(%ebx),%esi
80103e69:	8d 7b 68             	lea    0x68(%ebx),%edi
80103e6c:	68 20 2d 11 80       	push   $0x80112d20
80103e71:	e8 4a 0c 00 00       	call   80104ac0 <release>
  for(fd = 0; fd < NOFILE; fd++){
80103e76:	83 c4 10             	add    $0x10,%esp
80103e79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd]){
80103e80:	8b 06                	mov    (%esi),%eax
80103e82:	85 c0                	test   %eax,%eax
80103e84:	74 12                	je     80103e98 <exit+0x88>
      fileclose(curproc->ofile[fd]);
80103e86:	83 ec 0c             	sub    $0xc,%esp
80103e89:	50                   	push   %eax
80103e8a:	e8 61 d0 ff ff       	call   80100ef0 <fileclose>
      curproc->ofile[fd] = 0;
80103e8f:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103e95:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103e98:	83 c6 04             	add    $0x4,%esi
80103e9b:	39 f7                	cmp    %esi,%edi
80103e9d:	75 e1                	jne    80103e80 <exit+0x70>
  begin_op();
80103e9f:	e8 bc ee ff ff       	call   80102d60 <begin_op>
  iput(curproc->cwd);
80103ea4:	83 ec 0c             	sub    $0xc,%esp
80103ea7:	ff 73 68             	push   0x68(%ebx)
80103eaa:	e8 01 da ff ff       	call   801018b0 <iput>
  end_op();
80103eaf:	e8 1c ef ff ff       	call   80102dd0 <end_op>
  curproc->cwd = 0;
80103eb4:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103ebb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ec2:	e8 59 0c 00 00       	call   80104b20 <acquire>
  wakeup1(curproc->parent);
80103ec7:	8b 43 14             	mov    0x14(%ebx),%eax
80103eca:	e8 e1 f8 ff ff       	call   801037b0 <wakeup1>
      p->parent = initproc;
80103ecf:	8b 0d 54 8c 11 80    	mov    0x80118c54,%ecx
80103ed5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed8:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103edd:	eb 0f                	jmp    80103eee <exit+0xde>
80103edf:	90                   	nop
80103ee0:	81 c2 7c 01 00 00    	add    $0x17c,%edx
80103ee6:	81 fa 54 8c 11 80    	cmp    $0x80118c54,%edx
80103eec:	74 3a                	je     80103f28 <exit+0x118>
    if(p->parent == curproc){
80103eee:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103ef1:	75 ed                	jne    80103ee0 <exit+0xd0>
      if(p->state == ZOMBIE)
80103ef3:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103ef7:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103efa:	75 e4                	jne    80103ee0 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103efc:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103f01:	eb 11                	jmp    80103f14 <exit+0x104>
80103f03:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f07:	90                   	nop
80103f08:	05 7c 01 00 00       	add    $0x17c,%eax
80103f0d:	3d 54 8c 11 80       	cmp    $0x80118c54,%eax
80103f12:	74 cc                	je     80103ee0 <exit+0xd0>
    if(p->state == SLEEPING && p->chan == chan)
80103f14:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103f18:	75 ee                	jne    80103f08 <exit+0xf8>
80103f1a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103f1d:	75 e9                	jne    80103f08 <exit+0xf8>
      p->state = RUNNABLE;
80103f1f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103f26:	eb e0                	jmp    80103f08 <exit+0xf8>
  curproc->state = ZOMBIE;
80103f28:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103f2f:	e8 1c fe ff ff       	call   80103d50 <sched>
  panic("zombie exit");
80103f34:	83 ec 0c             	sub    $0xc,%esp
80103f37:	68 28 7e 10 80       	push   $0x80107e28
80103f3c:	e8 3f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f41:	83 ec 0c             	sub    $0xc,%esp
80103f44:	68 1b 7e 10 80       	push   $0x80107e1b
...
80103f54:	53                   	push   %ebx
  pushcli();
80103f55:	e8 76 0a 00 00       	call   801049d0 <pushcli>
  c = mycpu();
80103f5a:	e8 e1 f9 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80103f5f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f65:	e8 b6 0a 00 00       	call   80104a20 <popcli>
  acquire(&ptable.lock);
80103f6a:	83 ec 0c             	sub    $0xc,%esp
80103f6d:	68 20 2d 11 80       	push   $0x80112d20
80103f72:	e8 a9 0b 00 00       	call   80104b20 <acquire>
...
80103f87:	90                   	nop
80103f88:	81 c3 7c 01 00 00    	add    $0x17c,%ebx
80103f8e:	81 fb 54 8c 11 80    	cmp    $0x80118c54,%ebx
...
80103f9f:	74 5f                	je     80104000 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa1:	81 c3 7c 01 00 00    	add    $0x17c,%ebx
      havekids = 1;
80103fa7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fac:	81 fb 54 8c 11 80    	cmp    $0x80118c54,%ebx
...
80103fc1:	0f 85 8f 00 00 00    	jne    80104056 <wait+0x106>
  pushcli();
80103fc7:	e8 04 0a 00 00       	call   801049d0 <pushcli>
  c = mycpu();
80103fcc:	e8 6f f9 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80103fd1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fd7:	e8 44 0a 00 00       	call   80104a20 <popcli>
  if(p == 0)
...
80103fe7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fee:	e8 5d fd ff ff       	call   80103d50 <sched>
  p->chan = 0;
...
80104019:	e8 72 34 00 00       	call   80107490 <freevm>
        p->pid = 0;
...
80104045:	e8 76 0a 00 00       	call   80104ac0 <release>
        return pid;
...
8010408c:	e8 8f 0a 00 00       	call   80104b20 <acquire>
  pushcli();
80104091:	e8 3a 09 00 00       	call   801049d0 <pushcli>
  c = mycpu();
80104096:	e8 a5 f8 ff ff       	call   80103940 <mycpu>
  p = c->proc;
8010409b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040a1:	e8 7a 09 00 00       	call   80104a20 <popcli>
...
801040b9:	e8 02 0a 00 00       	call   80104ac0 <release>
}
...
801040dc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040df:	e8 ec 08 00 00       	call   801049d0 <pushcli>
  c = mycpu();
801040e4:	e8 57 f8 ff ff       	call   80103940 <mycpu>
  p = c->proc;
801040e9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040ef:	e8 2c 09 00 00       	call   80104a20 <popcli>
  if(p == 0)
...
80104110:	e8 0b 0a 00 00       	call   80104b20 <acquire>
    release(lk);
80104115:	89 34 24             	mov    %esi,(%esp)
80104118:	e8 a3 09 00 00       	call   80104ac0 <release>
  p->chan = chan;
...
8010413a:	e8 81 09 00 00       	call   80104ac0 <release>
    acquire(lk);
...
8010414b:	5d                   	pop    %ebp
    acquire(lk);
8010414c:	e9 cf 09 00 00       	jmp    80104b20 <acquire>
...
80104179:	68 3a 7e 10 80       	push   $0x80107e3a
8010417e:	e8 fd c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104183:	83 ec 0c             	sub    $0xc,%esp
80104186:	68 34 7e 10 80       	push   $0x80107e34
...
8010419f:	e8 7c 09 00 00       	call   80104b20 <acquire>
...
801041b0:	05 7c 01 00 00       	add    $0x17c,%eax
801041b5:	3d 54 8c 11 80       	cmp    $0x80118c54,%eax
...
801041c7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ce:	05 7c 01 00 00       	add    $0x17c,%eax
801041d3:	3d 54 8c 11 80       	cmp    $0x80118c54,%eax
...
801041e4:	c9                   	leave  
  release(&ptable.lock);
801041e5:	e9 d6 08 00 00       	jmp    80104ac0 <release>
...
801041ff:	e8 1c 09 00 00       	call   80104b20 <acquire>
...
80104210:	05 7c 01 00 00       	add    $0x17c,%eax
80104215:	3d 54 8c 11 80       	cmp    $0x80118c54,%eax
...
8010423d:	e8 7e 08 00 00       	call   80104ac0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104258:	e8 63 08 00 00       	call   80104ac0 <release>
}
...
80104280:	e8 9b 08 00 00       	call   80104b20 <acquire>
80104285:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104288:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010428d:	eb 0e                	jmp    8010429d <kill_threads+0x2d>
8010428f:	89 f0                	mov    %esi,%eax
80104291:	81 fe 54 8c 11 80    	cmp    $0x80118c54,%esi
80104297:	0f 84 a4 00 00 00    	je     80104341 <kill_threads+0xd1>
    if(p->pid == pid && p->state != UNUSED){
8010429d:	8b 5d 08             	mov    0x8(%ebp),%ebx
801042a0:	8d b0 7c 01 00 00    	lea    0x17c(%eax),%esi
801042a6:	39 58 10             	cmp    %ebx,0x10(%eax)
801042a9:	75 e4                	jne    8010428f <kill_threads+0x1f>
801042ab:	8b 50 0c             	mov    0xc(%eax),%edx
801042ae:	85 d2                	test   %edx,%edx
801042b0:	74 dd                	je     8010428f <kill_threads+0x1f>
      for(int i=0; i<NTHREAD; i++){
        t = p->threads[i];
801042b2:	8b 48 7c             	mov    0x7c(%eax),%ecx
801042b5:	8d 50 7c             	lea    0x7c(%eax),%edx
        if(t && t->state != T_UNUSED && t->state != T_ZOMBIE){
801042b8:	85 c9                	test   %ecx,%ecx
801042ba:	74 75                	je     80104331 <kill_threads+0xc1>
801042bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042c0:	8b 59 18             	mov    0x18(%ecx),%ebx
801042c3:	83 fb 05             	cmp    $0x5,%ebx
801042c6:	74 69                	je     80104331 <kill_threads+0xc1>
801042c8:	85 db                	test   %ebx,%ebx
801042ca:	74 65                	je     80104331 <kill_threads+0xc1>
          t->state = T_ZOMBIE;
801042cc:	c7 41 18 05 00 00 00 	movl   $0x5,0x18(%ecx)
          t->killed = 1;
          kill_cnt++;
801042d3:	83 c7 01             	add    $0x1,%edi
          t->killed = 1;
801042d6:	c7 41 14 01 00 00 00 	movl   $0x1,0x14(%ecx)
        }
        if(kill_cnt > 0){
          p->killed = 1;
801042dd:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042e4:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
801042e9:	eb 13                	jmp    801042fe <kill_threads+0x8e>
801042eb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042ef:	90                   	nop
801042f0:	81 c1 7c 01 00 00    	add    $0x17c,%ecx
801042f6:	81 f9 54 8c 11 80    	cmp    $0x80118c54,%ecx
801042fc:	74 22                	je     80104320 <kill_threads+0xb0>
    if(p->state == SLEEPING && p->chan == chan)
801042fe:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80104302:	75 ec                	jne    801042f0 <kill_threads+0x80>
80104304:	39 41 20             	cmp    %eax,0x20(%ecx)
80104307:	75 e7                	jne    801042f0 <kill_threads+0x80>
      p->state = RUNNABLE;
80104309:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104310:	81 c1 7c 01 00 00    	add    $0x17c,%ecx
80104316:	81 f9 54 8c 11 80    	cmp    $0x80118c54,%ecx
8010431c:	75 e0                	jne    801042fe <kill_threads+0x8e>
8010431e:	66 90                	xchg   %ax,%ax
      for(int i=0; i<NTHREAD; i++){
80104320:	83 c2 04             	add    $0x4,%edx
80104323:	39 d6                	cmp    %edx,%esi
80104325:	0f 84 64 ff ff ff    	je     8010428f <kill_threads+0x1f>
        t = p->threads[i];
8010432b:	8b 0a                	mov    (%edx),%ecx
        if(t && t->state != T_UNUSED && t->state != T_ZOMBIE){
8010432d:	85 c9                	test   %ecx,%ecx
8010432f:	75 8f                	jne    801042c0 <kill_threads+0x50>
        if(kill_cnt > 0){
80104331:	85 ff                	test   %edi,%edi
80104333:	75 a8                	jne    801042dd <kill_threads+0x6d>
      for(int i=0; i<NTHREAD; i++){
80104335:	83 c2 04             	add    $0x4,%edx
80104338:	39 d6                	cmp    %edx,%esi
8010433a:	75 ef                	jne    8010432b <kill_threads+0xbb>
8010433c:	e9 4e ff ff ff       	jmp    8010428f <kill_threads+0x1f>
          wakeup1(p);
        }
      }
    }
...
80104349:	e8 72 07 00 00       	call   80104ac0 <release>
  return kill_cnt > 0 ? 0 : -1; // thread가 존재하면 0, 존재하지 않으면 -1 반환
8010434e:	83 c4 10             	add    $0x10,%esp
80104351:	83 ff 01             	cmp    $0x1,%edi
80104354:	19 c0                	sbb    %eax,%eax
}
80104356:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104359:	5b                   	pop    %ebx
8010435a:	5e                   	pop    %esi
8010435b:	5f                   	pop    %edi
8010435c:	5d                   	pop    %ebp
...
8010437b:	68 67 82 10 80       	push   $0x80108267
80104380:	e8 1b c3 ff ff       	call   801006a0 <cprintf>
80104385:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104388:	81 c3 7c 01 00 00    	add    $0x17c,%ebx
8010438e:	81 fb c0 8c 11 80    	cmp    $0x80118cc0,%ebx
...
8010439f:	74 e7                	je     80104388 <procdump+0x28>
      state = "???";
801043a1:	ba 4b 7e 10 80       	mov    $0x80107e4b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043a6:	83 f8 05             	cmp    $0x5,%eax
801043a9:	77 11                	ja     801043bc <procdump+0x5c>
801043ab:	8b 14 85 4c 7f 10 80 	mov    -0x7fef80b4(,%eax,4),%edx
      state = "???";
801043b2:	b8 4b 7e 10 80       	mov    $0x80107e4b,%eax
...
801043c1:	68 4f 7e 10 80       	push   $0x80107e4f
...
801043e8:	e8 83 05 00 00       	call   80104970 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801043fd:	68 a1 78 10 80       	push   $0x801078a1
...
80104426:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80104429:	e8 a2 05 00 00       	call   801049d0 <pushcli>
  c = mycpu();
8010442e:	e8 0d f5 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80104433:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104439:	e8 e2 05 00 00       	call   80104a20 <popcli>
  struct proc *curproc = myproc();
  struct thread *t = 0;
  uint sp;
...
80104446:	e8 d5 06 00 00       	call   80104b20 <acquire>

  for(int i=0; i<NTHREAD; i++){
8010444b:	8d 46 7c             	lea    0x7c(%esi),%eax
8010444e:	8d 96 7c 01 00 00    	lea    0x17c(%esi),%edx
80104454:	83 c4 10             	add    $0x10,%esp
80104457:	eb 12                	jmp    8010446b <thread_create+0x4b>
80104459:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104460:	83 c0 04             	add    $0x4,%eax
80104463:	39 c2                	cmp    %eax,%edx
80104465:	0f 84 05 01 00 00    	je     80104570 <thread_create+0x150>
    if(curproc->threads[i]->state == T_UNUSED){
8010446b:	8b 18                	mov    (%eax),%ebx
8010446d:	8b 4b 18             	mov    0x18(%ebx),%ecx
80104470:	85 c9                	test   %ecx,%ecx
80104472:	75 ec                	jne    80104460 <thread_create+0x40>
      t = curproc->threads[i];
      // Initialize thread structure
      t->state = T_UNUSED;
      t->tid = 0;
80104474:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
...
8010447b:	83 ec 04             	sub    $0x4,%esp
      t->pgdir = 0;
8010447e:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
      t->tf = 0;
80104485:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
      t->pgdir = curproc->pgdir;
8010448c:	8b 46 04             	mov    0x4(%esi),%eax
      t->state = T_EMBRYO;
8010448f:	c7 43 18 01 00 00 00 	movl   $0x1,0x18(%ebx)
      t->pgdir = curproc->pgdir;
80104496:	89 43 04             	mov    %eax,0x4(%ebx)
      t->tid = nexttid++;
80104499:	a1 04 b0 10 80       	mov    0x8010b004,%eax
8010449e:	8d 50 01             	lea    0x1(%eax),%edx
801044a1:	89 43 1c             	mov    %eax,0x1c(%ebx)
801044a4:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  *thread = t->tid; // 해당 주소에 thread id 저장
801044aa:	8b 55 08             	mov    0x8(%ebp),%edx
801044ad:	89 02                	mov    %eax,(%edx)
  sp = curproc->sz; // stack pointer를 process의 크기로 설정
801044af:	8b 36                	mov    (%esi),%esi
  sp -= PGSIZE; // stack 크기만큼 stack pointer를 내림
801044b1:	8d 86 00 f0 ff ff    	lea    -0x1000(%esi),%eax
  if(allocuvm(t->pgdir, sp, sp + PGSIZE) == 0){
801044b7:	56                   	push   %esi
801044b8:	50                   	push   %eax
801044b9:	ff 73 04             	push   0x4(%ebx)
801044bc:	e8 6f 2e 00 00       	call   80107330 <allocuvm>
801044c1:	83 c4 10             	add    $0x10,%esp
801044c4:	85 c0                	test   %eax,%eax
801044c6:	74 75                	je     8010453d <thread_create+0x11d>
    release(&ptable.lock);
    return -1;
  }
  sp = sp + PGSIZE - 4;
...
801044c8:	e8 b3 e1 ff ff       	call   80102680 <kalloc>
  sp = sp + PGSIZE - 4;
801044cd:	8d 7e fc             	lea    -0x4(%esi),%edi
  t->tf = (struct trapframe*)kalloc();
801044d0:	89 43 08             	mov    %eax,0x8(%ebx)
  if(t->tf == 0){
801044d3:	85 c0                	test   %eax,%eax
801044d5:	0f 84 b8 00 00 00    	je     80104593 <thread_create+0x173>
    release(&ptable.lock);
    return -1;
  }
...
801044de:	83 ec 08             	sub    $0x8,%esp
  t->tf->eip = (uint)start_routine; // thread가 시작할 함수 지정
801044e1:	89 50 38             	mov    %edx,0x38(%eax)
  t->tf->esp = sp; // stack pointer
801044e4:	8b 43 08             	mov    0x8(%ebx),%eax
  sp -= 4;
801044e7:	8d 56 f4             	lea    -0xc(%esi),%edx
  t->tf->esp = sp; // stack pointer
801044ea:	89 78 44             	mov    %edi,0x44(%eax)
  t->tf->ebp = sp; // ebp는 esp와 같은 위치로 설정
801044ed:	8b 43 08             	mov    0x8(%ebx),%eax
801044f0:	89 78 08             	mov    %edi,0x8(%eax)
  t->tf->eax = 0;  // return value
801044f3:	8b 43 08             	mov    0x8(%ebx),%eax
801044f6:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  *(uint*)sp = (uint)arg; // Start_routine에 넘겨줄 인자
801044fd:	8b 45 10             	mov    0x10(%ebp),%eax
  *(uint*)sp = 0xffffffff; // fake return PC
80104500:	c7 46 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%esi)
  *(uint*)sp = (uint)arg; // Start_routine에 넘겨줄 인자
80104507:	89 46 f8             	mov    %eax,-0x8(%esi)
  t->tf->esp = sp; // stack pointer update
8010450a:	8b 43 08             	mov    0x8(%ebx),%eax
8010450d:	89 50 44             	mov    %edx,0x44(%eax)
  cprintf("Thread %d created successfully.\n", t->tid);
80104510:	ff 73 1c             	push   0x1c(%ebx)
80104513:	68 28 7f 10 80       	push   $0x80107f28
80104518:	e8 83 c1 ff ff       	call   801006a0 <cprintf>
  t->state = T_RUNNABLE;
8010451d:	c7 43 18 03 00 00 00 	movl   $0x3,0x18(%ebx)

  release(&ptable.lock);
80104524:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010452b:	e8 90 05 00 00       	call   80104ac0 <release>
  return 0;
80104530:	83 c4 10             	add    $0x10,%esp
80104533:	31 c0                	xor    %eax,%eax
}
80104535:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104538:	5b                   	pop    %ebx
80104539:	5e                   	pop    %esi
8010453a:	5f                   	pop    %edi
8010453b:	5d                   	pop    %ebp
...
80104540:	68 d8 7e 10 80       	push   $0x80107ed8
80104545:	e8 56 c1 ff ff       	call   801006a0 <cprintf>
    t->state = T_UNUSED;
8010454a:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
    release(&ptable.lock);
80104551:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104558:	e8 63 05 00 00       	call   80104ac0 <release>
    return -1;
8010455d:	83 c4 10             	add    $0x10,%esp
80104560:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104565:	eb ce                	jmp    80104535 <thread_create+0x115>
...
80104573:	68 58 7e 10 80       	push   $0x80107e58
80104578:	e8 23 c1 ff ff       	call   801006a0 <cprintf>
    release(&ptable.lock);
8010457d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104584:	e8 37 05 00 00       	call   80104ac0 <release>
    return -1;
80104589:	83 c4 10             	add    $0x10,%esp
8010458c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104591:	eb a2                	jmp    80104535 <thread_create+0x115>
    cprintf("Failed to allocate trap frame.\n");
80104593:	83 ec 0c             	sub    $0xc,%esp
    deallocuvm(t->pgdir, sp, sp - PGSIZE);
80104596:	81 ee 04 10 00 00    	sub    $0x1004,%esi
    cprintf("Failed to allocate trap frame.\n");
8010459c:	68 08 7f 10 80       	push   $0x80107f08
801045a1:	e8 fa c0 ff ff       	call   801006a0 <cprintf>
    deallocuvm(t->pgdir, sp, sp - PGSIZE);
801045a6:	83 c4 0c             	add    $0xc,%esp
801045a9:	56                   	push   %esi
801045aa:	57                   	push   %edi
801045ab:	ff 73 04             	push   0x4(%ebx)
801045ae:	e8 ad 2e 00 00       	call   80107460 <deallocuvm>
801045b3:	eb 95                	jmp    8010454a <thread_create+0x12a>
801045b5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801045bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801045c0 <thread_exit>:
...
801045c9:	e8 f2 f3 ff ff       	call   801039c0 <myproc>
  struct thread *t = 0;
  int fd;

  if(curproc == initproc)
801045ce:	39 05 54 8c 11 80    	cmp    %eax,0x80118c54
801045d4:	74 7d                	je     80104653 <thread_exit+0x93>
    panic("init exiting");

  acquire(&ptable.lock);
801045d6:	83 ec 0c             	sub    $0xc,%esp
801045d9:	89 c6                	mov    %eax,%esi
801045db:	68 20 2d 11 80       	push   $0x80112d20
801045e0:	8d 5e 7c             	lea    0x7c(%esi),%ebx
801045e3:	8d be 7c 01 00 00    	lea    0x17c(%esi),%edi
801045e9:	e8 32 05 00 00       	call   80104b20 <acquire>
  for(int i=0; i<NTHREAD; i++){
801045ee:	83 c4 10             	add    $0x10,%esp
  acquire(&ptable.lock);
801045f1:	89 d8                	mov    %ebx,%eax
801045f3:	eb 0a                	jmp    801045ff <thread_exit+0x3f>
801045f5:	8d 76 00             	lea    0x0(%esi),%esi
  for(int i=0; i<NTHREAD; i++){
801045f8:	83 c0 04             	add    $0x4,%eax
801045fb:	39 f8                	cmp    %edi,%eax
801045fd:	74 61                	je     80104660 <thread_exit+0xa0>
    if(curproc->threads[i] && curproc->threads[i]->state == T_RUNNING){
801045ff:	8b 08                	mov    (%eax),%ecx
80104601:	85 c9                	test   %ecx,%ecx
80104603:	74 f3                	je     801045f8 <thread_exit+0x38>
80104605:	83 79 18 04          	cmpl   $0x4,0x18(%ecx)
80104609:	75 ed                	jne    801045f8 <thread_exit+0x38>
...
8010460b:	8b 45 08             	mov    0x8(%ebp),%eax
  t->state = T_ZOMBIE;
8010460e:	c7 41 18 05 00 00 00 	movl   $0x5,0x18(%ecx)
  t->retval = retval;
80104615:	89 41 20             	mov    %eax,0x20(%ecx)

  wakeup1(t);
80104618:	89 c8                	mov    %ecx,%eax
8010461a:	e8 91 f1 ff ff       	call   801037b0 <wakeup1>

  int all_zombies = 1; // 모든 thread가 종료되었는지 확인
  for(int i=0; i<NTHREAD; i++){
8010461f:	eb 0e                	jmp    8010462f <thread_exit+0x6f>
80104621:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104628:	83 c3 04             	add    $0x4,%ebx
8010462b:	39 fb                	cmp    %edi,%ebx
8010462d:	74 3e                	je     8010466d <thread_exit+0xad>
    if(curproc->threads[i] != t){
8010462f:	8b 03                	mov    (%ebx),%eax
80104631:	39 c1                	cmp    %eax,%ecx
80104633:	74 f3                	je     80104628 <thread_exit+0x68>
...
8010463b:	74 eb                	je     80104628 <thread_exit+0x68>
8010463d:	85 c0                	test   %eax,%eax
8010463f:	74 e7                	je     80104628 <thread_exit+0x68>
          wakeup1(initproc);
      }
    }
    curproc->state = ZOMBIE;
  ...
  sched();
80104641:	e8 0a f7 ff ff       	call   80103d50 <sched>
  panic("zombie exit");
80104646:	83 ec 0c             	sub    $0xc,%esp
80104649:	68 28 7e 10 80       	push   $0x80107e28
8010464e:	e8 2d bd ff ff       	call   80100380 <panic>
    panic("init exiting");
80104653:	83 ec 0c             	sub    $0xc,%esp
80104656:	68 1b 7e 10 80       	push   $0x80107e1b
8010465b:	e8 20 bd ff ff       	call   80100380 <panic>
    panic("No running thread");
80104660:	83 ec 0c             	sub    $0xc,%esp
80104663:	68 73 7e 10 80       	push   $0x80107e73
80104668:	e8 13 bd ff ff       	call   80100380 <panic>
8010466d:	8d 5e 28             	lea    0x28(%esi),%ebx
80104670:	8d 7e 68             	lea    0x68(%esi),%edi
80104673:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104677:	90                   	nop
      if(curproc->ofile[fd]){
80104678:	8b 03                	mov    (%ebx),%eax
8010467a:	85 c0                	test   %eax,%eax
8010467c:	74 12                	je     80104690 <thread_exit+0xd0>
        fileclose(curproc->ofile[fd]);
8010467e:	83 ec 0c             	sub    $0xc,%esp
80104681:	50                   	push   %eax
80104682:	e8 69 c8 ff ff       	call   80100ef0 <fileclose>
        curproc->ofile[fd] = 0;
80104687:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
8010468d:	83 c4 10             	add    $0x10,%esp
    for(fd = 0; fd < NOFILE; fd++){
80104690:	83 c3 04             	add    $0x4,%ebx
80104693:	39 fb                	cmp    %edi,%ebx
80104695:	75 e1                	jne    80104678 <thread_exit+0xb8>
    begin_op();
80104697:	e8 c4 e6 ff ff       	call   80102d60 <begin_op>
    iput(curproc->cwd);
8010469c:	83 ec 0c             	sub    $0xc,%esp
8010469f:	ff 76 68             	push   0x68(%esi)
801046a2:	e8 09 d2 ff ff       	call   801018b0 <iput>
    end_op();
801046a7:	e8 24 e7 ff ff       	call   80102dd0 <end_op>
    curproc->cwd = 0;
801046ac:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
801046b3:	83 c4 10             	add    $0x10,%esp
    for(p=ptable.proc; p<&ptable.proc[NPROC]; p++){
801046b6:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
801046bb:	eb 11                	jmp    801046ce <thread_exit+0x10e>
801046bd:	8d 76 00             	lea    0x0(%esi),%esi
801046c0:	81 c1 7c 01 00 00    	add    $0x17c,%ecx
801046c6:	81 f9 54 8c 11 80    	cmp    $0x80118c54,%ecx
801046cc:	74 26                	je     801046f4 <thread_exit+0x134>
      if(p->parent == curproc){
801046ce:	39 71 14             	cmp    %esi,0x14(%ecx)
801046d1:	75 ed                	jne    801046c0 <thread_exit+0x100>
        p->parent = initproc;
801046d3:	a1 54 8c 11 80       	mov    0x80118c54,%eax
        if(p->state == ZOMBIE)
801046d8:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
        p->parent = initproc;
801046dc:	89 41 14             	mov    %eax,0x14(%ecx)
        if(p->state == ZOMBIE)
801046df:	75 df                	jne    801046c0 <thread_exit+0x100>
          wakeup1(initproc);
801046e1:	e8 ca f0 ff ff       	call   801037b0 <wakeup1>
    for(p=ptable.proc; p<&ptable.proc[NPROC]; p++){
801046e6:	81 c1 7c 01 00 00    	add    $0x17c,%ecx
801046ec:	81 f9 54 8c 11 80    	cmp    $0x80118c54,%ecx
801046f2:	75 da                	jne    801046ce <thread_exit+0x10e>
    curproc->state = ZOMBIE;
801046f4:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
801046fb:	e9 41 ff ff ff       	jmp    80104641 <thread_exit+0x81>

80104700 <thread_join>:
...
80104709:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
8010470c:	e8 bf 02 00 00       	call   801049d0 <pushcli>
  c = mycpu();
80104711:	e8 2a f2 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80104716:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
8010471c:	89 7d dc             	mov    %edi,-0x24(%ebp)
  popcli();
8010471f:	e8 fc 02 00 00       	call   80104a20 <popcli>
  struct proc *curproc = myproc();
  struct thread *t;
  int found = 0;
...
80104727:	68 20 2d 11 80       	push   $0x80112d20
8010472c:	e8 ef 03 00 00       	call   80104b20 <acquire>
80104731:	8d 57 7c             	lea    0x7c(%edi),%edx
80104734:	83 c4 10             	add    $0x10,%esp
80104737:	8d bf 7c 01 00 00    	lea    0x17c(%edi),%edi
8010473d:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  while (1) {
    found = 0;
    for (int i = 0; i < NTHREAD; i++) {
80104740:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104743:	eb 0a                	jmp    8010474f <thread_join+0x4f>
80104745:	8d 76 00             	lea    0x0(%esi),%esi
80104748:	83 c0 04             	add    $0x4,%eax
8010474b:	39 c7                	cmp    %eax,%edi
8010474d:	74 61                	je     801047b0 <thread_join+0xb0>
      t = curproc->threads[i];
8010474f:	8b 18                	mov    (%eax),%ebx
      if (t && t->tid == thread) {
80104751:	85 db                	test   %ebx,%ebx
80104753:	74 f3                	je     80104748 <thread_join+0x48>
80104755:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80104758:	75 ee                	jne    80104748 <thread_join+0x48>
        found = 1;
        if (t->state == T_ZOMBIE) {
8010475a:	83 7b 18 05          	cmpl   $0x5,0x18(%ebx)
8010475e:	74 6d                	je     801047cd <thread_join+0xcd>
        break;
      }
    }
...
80104760:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104763:	8b 40 24             	mov    0x24(%eax),%eax
80104766:	85 c0                	test   %eax,%eax
80104768:	75 46                	jne    801047b0 <thread_join+0xb0>
  pushcli();
8010476a:	e8 61 02 00 00       	call   801049d0 <pushcli>
  c = mycpu();
8010476f:	e8 cc f1 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80104774:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010477a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  popcli();
8010477d:	e8 9e 02 00 00       	call   80104a20 <popcli>
  if(p == 0)
80104782:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104785:	85 c0                	test   %eax,%eax
80104787:	74 7c                	je     80104805 <thread_join+0x105>
  p->chan = chan;
80104789:	89 58 20             	mov    %ebx,0x20(%eax)
  p->state = SLEEPING;
8010478c:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
80104793:	89 45 e0             	mov    %eax,-0x20(%ebp)
  sched();
80104796:	e8 b5 f5 ff ff       	call   80103d50 <sched>
  p->chan = 0;
8010479b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010479e:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
}
801047a5:	eb 99                	jmp    80104740 <thread_join+0x40>
...
801047b8:	e8 03 03 00 00       	call   80104ac0 <release>
      return -1;
...
801047cc:	c3                   	ret    
          if (retval) 
801047cd:	8b 55 0c             	mov    0xc(%ebp),%edx
801047d0:	85 d2                	test   %edx,%edx
801047d2:	74 08                	je     801047dc <thread_join+0xdc>
            *retval = t->retval;
801047d4:	8b 43 20             	mov    0x20(%ebx),%eax
801047d7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801047da:	89 01                	mov    %eax,(%ecx)
          release(&ptable.lock);
801047dc:	83 ec 0c             	sub    $0xc,%esp
          t->tid = 0;
801047df:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
          t->state = T_UNUSED;
801047e6:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
          t->retval = 0;
801047ed:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
          release(&ptable.lock);
801047f4:	68 20 2d 11 80       	push   $0x80112d20
801047f9:	e8 c2 02 00 00       	call   80104ac0 <release>
          return 0;
801047fe:	83 c4 10             	add    $0x10,%esp
80104801:	31 c0                	xor    %eax,%eax
80104803:	eb c0                	jmp    801047c5 <thread_join+0xc5>
    panic("sleep");
80104805:	83 ec 0c             	sub    $0xc,%esp
80104808:	68 34 7e 10 80       	push   $0x80107e34
...
8010482a:	68 64 7f 10 80       	push   $0x80107f64
...
80104885:	e8 46 f8 ff ff       	call   801040d0 <sleep>
  while (lk->locked) {
...
801048e4:	e8 a7 f8 ff ff       	call   80104190 <wakeup>
  release(&lk->lk);
...
80104a65:	68 6f 7f 10 80       	push   $0x80107f6f
80104a6a:	e8 11 b9 ff ff       	call   80100380 <panic>
    panic("popcli");
80104a6f:	83 ec 0c             	sub    $0xc,%esp
80104a72:	68 86 7f 10 80       	push   $0x80107f86
...
80104adb:	68 8d 7f 10 80       	push   $0x80107f8d
...
80104bd0:	68 95 7f 10 80       	push   $0x80107f95
...
80104ffc:	8b 14 85 c0 7f 10 80 	mov    -0x7fef8040(,%eax,4),%edx
...
80105028:	68 9d 7f 10 80       	push   $0x80107f9d
...
801051b1:	68 37 80 10 80       	push   $0x80108037
...
801051cf:	68 46 80 10 80       	push   $0x80108046
801051d4:	e8 a7 b1 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801051d9:	83 ec 0c             	sub    $0xc,%esp
801051dc:	68 28 80 10 80       	push   $0x80108028
...
801055dd:	58                   	pop    %eax
801055de:	5a                   	pop    %edx
801055df:	68 44 80 10 80       	push   $0x80108044
...
801055f8:	68 43 80 10 80       	push   $0x80108043
...
{
  return fork();
80105c10:	e9 7b df ff ff       	jmp    80103b90 <fork>
...
80105c23:	83 ec 08             	sub    $0x8,%esp
  exit();
80105c26:	e8 e5 e1 ff ff       	call   80103e10 <exit>
...
80105c5e:	e8 8d e5 ff ff       	call   801041f0 <kill>
...
80105c8c:	e8 0f f2 ff ff       	call   80104ea0 <argint>
80105c91:	83 c4 10             	add    $0x10,%esp
80105c94:	85 c0                	test   %eax,%eax
80105c96:	78 18                	js     80105cb0 <sys_kill_threads+0x30>
    return -1;
  return kill_threads(pid);
80105c98:	83 ec 0c             	sub    $0xc,%esp
80105c9b:	ff 75 f4             	push   -0xc(%ebp)
80105c9e:	e8 cd e5 ff ff       	call   80104270 <kill_threads>
...
80105cc3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105cc6:	e8 f5 dc ff ff       	call   801039c0 <myproc>
...
80105cf6:	e8 e5 dd ff ff       	call   80103ae0 <growproc>
...
80105d2d:	e8 6e f1 ff ff       	call   80104ea0 <argint>
...
80105d40:	68 80 8c 11 80       	push   $0x80118c80
80105d45:	e8 d6 ed ff ff       	call   80104b20 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105d4a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105d4d:	8b 1d 60 8c 11 80    	mov    0x80118c60,%ebx
  while(ticks - ticks0 < n){
...
80105d63:	68 80 8c 11 80       	push   $0x80118c80
80105d68:	68 60 8c 11 80       	push   $0x80118c60
80105d6d:	e8 5e e3 ff ff       	call   801040d0 <sleep>
  while(ticks - ticks0 < n){
80105d72:	a1 60 8c 11 80       	mov    0x80118c60,%eax
...
80105d7f:	73 2f                	jae    80105db0 <sys_sleep+0x90>
    if(myproc()->killed){
80105d81:	e8 3a dc ff ff       	call   801039c0 <myproc>
...
80105d90:	68 80 8c 11 80       	push   $0x80118c80
80105d95:	e8 26 ed ff ff       	call   80104ac0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105db3:	68 80 8c 11 80       	push   $0x80118c80
80105db8:	e8 03 ed ff ff       	call   80104ac0 <release>
  return 0;
...
80105dd4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105dd7:	68 80 8c 11 80       	push   $0x80118c80
80105ddc:	e8 3f ed ff ff       	call   80104b20 <acquire>
  xticks = ticks;
80105de1:	8b 1d 60 8c 11 80    	mov    0x80118c60,%ebx
  release(&tickslock);
80105de7:	c7 04 24 80 8c 11 80 	movl   $0x80118c80,(%esp)
80105dee:	e8 cd ec ff ff       	call   80104ac0 <release>
  return xticks;
}
...
80105e06:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105e09:	6a 04                	push   $0x4
80105e0b:	50                   	push   %eax
80105e0c:	6a 00                	push   $0x0
80105e0e:	e8 dd f0 ff ff       	call   80104ef0 <argptr>
80105e13:	83 c4 10             	add    $0x10,%esp
80105e16:	85 c0                	test   %eax,%eax
80105e18:	78 46                	js     80105e60 <sys_thread_create+0x60>
...
80105e7e:	e8 6d f0 ff ff       	call   80104ef0 <argptr>
80105e83:	83 c4 10             	add    $0x10,%esp
80105e86:	85 c0                	test   %eax,%eax
80105e88:	78 16                	js     80105ea0 <sys_thread_exit+0x30>
    return -1;
  thread_exit(retval);
80105e8a:	83 ec 0c             	sub    $0xc,%esp
80105e8d:	ff 75 f4             	push   -0xc(%ebp)
80105e90:	e8 2b e7 ff ff       	call   801045c0 <thread_exit>
  return 0;
...
80105ee8:	e8 13 e8 ff ff       	call   80104700 <thread_join>
...
80105f40:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105f47:	c7 04 c5 c2 8c 11 80 	movl   $0x8e000008,-0x7fee733e(,%eax,8)
80105f4e:	08 00 00 8e 
80105f52:	66 89 14 c5 c0 8c 11 	mov    %dx,-0x7fee7340(,%eax,8)
80105f59:	80 
80105f5a:	c1 ea 10             	shr    $0x10,%edx
80105f5d:	66 89 14 c5 c6 8c 11 	mov    %dx,-0x7fee733a(,%eax,8)
80105f64:	80 
  for(i = 0; i < 256; i++)
...
80105f6f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105f72:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105f77:	c7 05 c2 8e 11 80 08 	movl   $0xef000008,0x80118ec2
80105f7e:	00 00 ef 
  initlock(&tickslock, "time");
80105f81:	68 89 80 10 80       	push   $0x80108089
80105f86:	68 80 8c 11 80       	push   $0x80118c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105f8b:	66 a3 c0 8e 11 80    	mov    %ax,0x80118ec0
80105f91:	c1 e8 10             	shr    $0x10,%eax
80105f94:	66 a3 c6 8e 11 80    	mov    %ax,0x80118ec6
  initlock(&tickslock, "time");
80105f9a:	e8 b1 e9 ff ff       	call   80104950 <initlock>
}
...
80105fbb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105fbf:	b8 c0 8c 11 80       	mov    $0x80118cc0,%eax
...
80106004:	ff 24 85 30 81 10 80 	jmp    *-0x7fef7ed0(,%eax,4)
...
8010600f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106010:	e8 2b c2 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
8010601a:	e8 a1 d9 ff ff       	call   801039c0 <myproc>
8010601f:	85 c0                	test   %eax,%eax
80106021:	74 1d                	je     80106040 <trap+0x60>
80106023:	e8 98 d9 ff ff       	call   801039c0 <myproc>
...
80106040:	e8 7b d9 ff ff       	call   801039c0 <myproc>
80106045:	85 c0                	test   %eax,%eax
80106047:	74 0f                	je     80106058 <trap+0x78>
80106049:	e8 72 d9 ff ff       	call   801039c0 <myproc>
...
80106052:	0f 84 b8 00 00 00    	je     80106110 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106058:	e8 63 d9 ff ff       	call   801039c0 <myproc>
8010605d:	85 c0                	test   %eax,%eax
8010605f:	74 1d                	je     8010607e <trap+0x9e>
80106061:	e8 5a d9 ff ff       	call   801039c0 <myproc>
...
80106090:	e8 2b d9 ff ff       	call   801039c0 <myproc>
...
801060b0:	e8 eb d8 ff ff       	call   801039a0 <cpuid>
...
801060c1:	e8 fa d8 ff ff       	call   801039c0 <myproc>
801060c6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801060c9:	e8 f2 d8 ff ff       	call   801039c0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801060e5:	68 ec 80 10 80       	push   $0x801080ec
801060ea:	e8 b1 a5 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
801060ef:	83 c4 20             	add    $0x20,%esp
801060f2:	e8 c9 d8 ff ff       	call   801039c0 <myproc>
801060f7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060fe:	e8 bd d8 ff ff       	call   801039c0 <myproc>
...
80106114:	0f 85 3e ff ff ff    	jne    80106058 <trap+0x78>
    yield();
8010611a:	e8 61 df ff ff       	call   80104080 <yield>
...
8010612f:	e8 6c d8 ff ff       	call   801039a0 <cpuid>
80106134:	57                   	push   %edi
80106135:	56                   	push   %esi
80106136:	50                   	push   %eax
80106137:	68 94 80 10 80       	push   $0x80108094
8010613c:	e8 5f a5 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106141:	e8 ca c7 ff ff       	call   80102910 <lapiceoi>
    break;
80106146:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106149:	e8 72 d8 ff ff       	call   801039c0 <myproc>
...
8010615f:	90                   	nop
    if(myproc()->killed)
80106160:	e8 5b d8 ff ff       	call   801039c0 <myproc>
...
80106175:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80106178:	e8 63 ee ff ff       	call   80104fe0 <syscall>
    if(myproc()->killed)
8010617d:	e8 3e d8 ff ff       	call   801039c0 <myproc>
...
80106193:	5d                   	pop    %ebp
      exit();
80106194:	e9 77 dc ff ff       	jmp    80103e10 <exit>
...
801061a5:	e8 66 c7 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801061aa:	e8 11 d8 ff ff       	call   801039c0 <myproc>
...
801061bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801061c0:	e8 0b c6 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
801061c5:	e8 46 c7 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801061ca:	e8 f1 d7 ff ff       	call   801039c0 <myproc>
...
801061f0:	68 80 8c 11 80       	push   $0x80118c80
801061f5:	e8 26 e9 ff ff       	call   80104b20 <acquire>
      wakeup(&ticks);
801061fa:	c7 04 24 60 8c 11 80 	movl   $0x80118c60,(%esp)
      ticks++;
80106201:	83 05 60 8c 11 80 01 	addl   $0x1,0x80118c60
      wakeup(&ticks);
80106208:	e8 83 df ff ff       	call   80104190 <wakeup>
      release(&tickslock);
8010620d:	c7 04 24 80 8c 11 80 	movl   $0x80118c80,(%esp)
80106214:	e8 a7 e8 ff ff       	call   80104ac0 <release>
...
{
  if(!uart)
80106270:	a1 c0 94 11 80       	mov    0x801194c0,%eax
...
801062f7:	74 78                	je     80106371 <uartinit+0xd1>
  uart = 1;
801062f9:	c7 05 c0 94 11 80 01 	movl   $0x1,0x801194c0
80106300:	00 00 00 
...
8010630c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010630f:	bf b0 81 10 80       	mov    $0x801081b0,%edi
80106314:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106319:	6a 00                	push   $0x0
8010631b:	6a 04                	push   $0x4
8010631d:	e8 5e c1 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106329:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106330:	a1 c0 94 11 80       	mov    0x801194c0,%eax
...
80106345:	e8 e6 c5 ff ff       	call   80102930 <microdelay>
...
80106380 <uartputc>:
  if(!uart)
80106380:	a1 c0 94 11 80       	mov    0x801194c0,%eax
...
801063eb:	e8 90 a4 ff ff       	call   80100880 <consoleintr>
}
...
801063f7:	6a 00                	push   $0x0
  jmp alltraps
801063f9:	e9 01 fb ff ff       	jmp    80105eff <alltraps>
...
80106400:	6a 01                	push   $0x1
  jmp alltraps
80106402:	e9 f8 fa ff ff       	jmp    80105eff <alltraps>
...
80106409:	6a 02                	push   $0x2
  jmp alltraps
8010640b:	e9 ef fa ff ff       	jmp    80105eff <alltraps>
...
80106412:	6a 03                	push   $0x3
  jmp alltraps
80106414:	e9 e6 fa ff ff       	jmp    80105eff <alltraps>
...
8010641b:	6a 04                	push   $0x4
  jmp alltraps
8010641d:	e9 dd fa ff ff       	jmp    80105eff <alltraps>
...
80106424:	6a 05                	push   $0x5
  jmp alltraps
80106426:	e9 d4 fa ff ff       	jmp    80105eff <alltraps>
...
8010642d:	6a 06                	push   $0x6
  jmp alltraps
8010642f:	e9 cb fa ff ff       	jmp    80105eff <alltraps>
...
80106436:	6a 07                	push   $0x7
  jmp alltraps
80106438:	e9 c2 fa ff ff       	jmp    80105eff <alltraps>
...
8010643d:	6a 08                	push   $0x8
  jmp alltraps
8010643f:	e9 bb fa ff ff       	jmp    80105eff <alltraps>
...
80106446:	6a 09                	push   $0x9
  jmp alltraps
80106448:	e9 b2 fa ff ff       	jmp    80105eff <alltraps>
...
8010644d:	6a 0a                	push   $0xa
  jmp alltraps
8010644f:	e9 ab fa ff ff       	jmp    80105eff <alltraps>
...
8010645b:	6a 0c                	push   $0xc
  jmp alltraps
8010645d:	e9 9d fa ff ff       	jmp    80105eff <alltraps>
...
80106462:	6a 0d                	push   $0xd
  jmp alltraps
80106464:	e9 96 fa ff ff       	jmp    80105eff <alltraps>
...
80106469:	6a 0e                	push   $0xe
  jmp alltraps
8010646b:	e9 8f fa ff ff       	jmp    80105eff <alltraps>
...
80106472:	6a 0f                	push   $0xf
  jmp alltraps
80106474:	e9 86 fa ff ff       	jmp    80105eff <alltraps>
...
8010647b:	6a 10                	push   $0x10
  jmp alltraps
8010647d:	e9 7d fa ff ff       	jmp    80105eff <alltraps>
...
80106482:	6a 11                	push   $0x11
  jmp alltraps
80106484:	e9 76 fa ff ff       	jmp    80105eff <alltraps>
...
80106494:	6a 13                	push   $0x13
  jmp alltraps
80106496:	e9 64 fa ff ff       	jmp    80105eff <alltraps>
...
8010649d:	6a 14                	push   $0x14
  jmp alltraps
8010649f:	e9 5b fa ff ff       	jmp    80105eff <alltraps>
...
801064a6:	6a 15                	push   $0x15
  jmp alltraps
801064a8:	e9 52 fa ff ff       	jmp    80105eff <alltraps>
...
801064af:	6a 16                	push   $0x16
  jmp alltraps
801064b1:	e9 49 fa ff ff       	jmp    80105eff <alltraps>
...
801064b8:	6a 17                	push   $0x17
  jmp alltraps
801064ba:	e9 40 fa ff ff       	jmp    80105eff <alltraps>
...
801064c1:	6a 18                	push   $0x18
  jmp alltraps
801064c3:	e9 37 fa ff ff       	jmp    80105eff <alltraps>
...
801064ca:	6a 19                	push   $0x19
  jmp alltraps
801064cc:	e9 2e fa ff ff       	jmp    80105eff <alltraps>
...
801064d3:	6a 1a                	push   $0x1a
  jmp alltraps
801064d5:	e9 25 fa ff ff       	jmp    80105eff <alltraps>
...
801064dc:	6a 1b                	push   $0x1b
  jmp alltraps
801064de:	e9 1c fa ff ff       	jmp    80105eff <alltraps>
...
801064e5:	6a 1c                	push   $0x1c
  jmp alltraps
801064e7:	e9 13 fa ff ff       	jmp    80105eff <alltraps>
...
801064ee:	6a 1d                	push   $0x1d
  jmp alltraps
801064f0:	e9 0a fa ff ff       	jmp    80105eff <alltraps>
...
801064f7:	6a 1e                	push   $0x1e
  jmp alltraps
801064f9:	e9 01 fa ff ff       	jmp    80105eff <alltraps>
...
80106500:	6a 1f                	push   $0x1f
  jmp alltraps
80106502:	e9 f8 f9 ff ff       	jmp    80105eff <alltraps>
...
80106509:	6a 20                	push   $0x20
  jmp alltraps
8010650b:	e9 ef f9 ff ff       	jmp    80105eff <alltraps>
...
80106512:	6a 21                	push   $0x21
  jmp alltraps
80106514:	e9 e6 f9 ff ff       	jmp    80105eff <alltraps>
...
8010651b:	6a 22                	push   $0x22
  jmp alltraps
8010651d:	e9 dd f9 ff ff       	jmp    80105eff <alltraps>
...
80106524:	6a 23                	push   $0x23
  jmp alltraps
80106526:	e9 d4 f9 ff ff       	jmp    80105eff <alltraps>
...
8010652d:	6a 24                	push   $0x24
  jmp alltraps
8010652f:	e9 cb f9 ff ff       	jmp    80105eff <alltraps>
...
80106536:	6a 25                	push   $0x25
  jmp alltraps
80106538:	e9 c2 f9 ff ff       	jmp    80105eff <alltraps>
...
8010653f:	6a 26                	push   $0x26
  jmp alltraps
80106541:	e9 b9 f9 ff ff       	jmp    80105eff <alltraps>
...
80106548:	6a 27                	push   $0x27
  jmp alltraps
8010654a:	e9 b0 f9 ff ff       	jmp    80105eff <alltraps>
...
80106551:	6a 28                	push   $0x28
  jmp alltraps
80106553:	e9 a7 f9 ff ff       	jmp    80105eff <alltraps>
...
8010655a:	6a 29                	push   $0x29
  jmp alltraps
8010655c:	e9 9e f9 ff ff       	jmp    80105eff <alltraps>
...
80106563:	6a 2a                	push   $0x2a
  jmp alltraps
80106565:	e9 95 f9 ff ff       	jmp    80105eff <alltraps>
...
8010656c:	6a 2b                	push   $0x2b
  jmp alltraps
8010656e:	e9 8c f9 ff ff       	jmp    80105eff <alltraps>
...
80106575:	6a 2c                	push   $0x2c
  jmp alltraps
80106577:	e9 83 f9 ff ff       	jmp    80105eff <alltraps>
...
8010657e:	6a 2d                	push   $0x2d
  jmp alltraps
80106580:	e9 7a f9 ff ff       	jmp    80105eff <alltraps>
...
80106587:	6a 2e                	push   $0x2e
  jmp alltraps
80106589:	e9 71 f9 ff ff       	jmp    80105eff <alltraps>
...
80106590:	6a 2f                	push   $0x2f
  jmp alltraps
80106592:	e9 68 f9 ff ff       	jmp    80105eff <alltraps>
...
80106599:	6a 30                	push   $0x30
  jmp alltraps
8010659b:	e9 5f f9 ff ff       	jmp    80105eff <alltraps>
...
801065a2:	6a 31                	push   $0x31
  jmp alltraps
801065a4:	e9 56 f9 ff ff       	jmp    80105eff <alltraps>
...
801065ab:	6a 32                	push   $0x32
  jmp alltraps
801065ad:	e9 4d f9 ff ff       	jmp    80105eff <alltraps>
...
801065b4:	6a 33                	push   $0x33
  jmp alltraps
801065b6:	e9 44 f9 ff ff       	jmp    80105eff <alltraps>
...
801065bd:	6a 34                	push   $0x34
  jmp alltraps
801065bf:	e9 3b f9 ff ff       	jmp    80105eff <alltraps>
...
801065c6:	6a 35                	push   $0x35
  jmp alltraps
801065c8:	e9 32 f9 ff ff       	jmp    80105eff <alltraps>
...
801065cf:	6a 36                	push   $0x36
  jmp alltraps
801065d1:	e9 29 f9 ff ff       	jmp    80105eff <alltraps>
...
801065d8:	6a 37                	push   $0x37
  jmp alltraps
801065da:	e9 20 f9 ff ff       	jmp    80105eff <alltraps>
...
801065e1:	6a 38                	push   $0x38
  jmp alltraps
801065e3:	e9 17 f9 ff ff       	jmp    80105eff <alltraps>
...
801065ea:	6a 39                	push   $0x39
  jmp alltraps
801065ec:	e9 0e f9 ff ff       	jmp    80105eff <alltraps>
...
801065f3:	6a 3a                	push   $0x3a
  jmp alltraps
801065f5:	e9 05 f9 ff ff       	jmp    80105eff <alltraps>
...
801065fc:	6a 3b                	push   $0x3b
  jmp alltraps
801065fe:	e9 fc f8 ff ff       	jmp    80105eff <alltraps>
...
80106605:	6a 3c                	push   $0x3c
  jmp alltraps
80106607:	e9 f3 f8 ff ff       	jmp    80105eff <alltraps>
...
8010660e:	6a 3d                	push   $0x3d
  jmp alltraps
80106610:	e9 ea f8 ff ff       	jmp    80105eff <alltraps>
...
80106617:	6a 3e                	push   $0x3e
  jmp alltraps
80106619:	e9 e1 f8 ff ff       	jmp    80105eff <alltraps>
...
80106620:	6a 3f                	push   $0x3f
  jmp alltraps
80106622:	e9 d8 f8 ff ff       	jmp    80105eff <alltraps>
...
80106629:	6a 40                	push   $0x40
  jmp alltraps
8010662b:	e9 cf f8 ff ff       	jmp    80105eff <alltraps>
...
80106632:	6a 41                	push   $0x41
  jmp alltraps
80106634:	e9 c6 f8 ff ff       	jmp    80105eff <alltraps>
...
8010663b:	6a 42                	push   $0x42
  jmp alltraps
8010663d:	e9 bd f8 ff ff       	jmp    80105eff <alltraps>
...
80106644:	6a 43                	push   $0x43
  jmp alltraps
80106646:	e9 b4 f8 ff ff       	jmp    80105eff <alltraps>
...
8010664d:	6a 44                	push   $0x44
  jmp alltraps
8010664f:	e9 ab f8 ff ff       	jmp    80105eff <alltraps>
...
80106656:	6a 45                	push   $0x45
  jmp alltraps
80106658:	e9 a2 f8 ff ff       	jmp    80105eff <alltraps>
...
8010665f:	6a 46                	push   $0x46
  jmp alltraps
80106661:	e9 99 f8 ff ff       	jmp    80105eff <alltraps>
...
80106668:	6a 47                	push   $0x47
  jmp alltraps
8010666a:	e9 90 f8 ff ff       	jmp    80105eff <alltraps>
...
80106671:	6a 48                	push   $0x48
  jmp alltraps
80106673:	e9 87 f8 ff ff       	jmp    80105eff <alltraps>
...
8010667a:	6a 49                	push   $0x49
  jmp alltraps
8010667c:	e9 7e f8 ff ff       	jmp    80105eff <alltraps>
...
80106683:	6a 4a                	push   $0x4a
  jmp alltraps
80106685:	e9 75 f8 ff ff       	jmp    80105eff <alltraps>
...
8010668c:	6a 4b                	push   $0x4b
  jmp alltraps
8010668e:	e9 6c f8 ff ff       	jmp    80105eff <alltraps>
...
80106695:	6a 4c                	push   $0x4c
  jmp alltraps
80106697:	e9 63 f8 ff ff       	jmp    80105eff <alltraps>
...
8010669e:	6a 4d                	push   $0x4d
  jmp alltraps
801066a0:	e9 5a f8 ff ff       	jmp    80105eff <alltraps>
...
801066a7:	6a 4e                	push   $0x4e
  jmp alltraps
801066a9:	e9 51 f8 ff ff       	jmp    80105eff <alltraps>
...
801066b0:	6a 4f                	push   $0x4f
  jmp alltraps
801066b2:	e9 48 f8 ff ff       	jmp    80105eff <alltraps>
...
801066b9:	6a 50                	push   $0x50
  jmp alltraps
801066bb:	e9 3f f8 ff ff       	jmp    80105eff <alltraps>
...
801066c2:	6a 51                	push   $0x51
  jmp alltraps
801066c4:	e9 36 f8 ff ff       	jmp    80105eff <alltraps>
...
801066cb:	6a 52                	push   $0x52
  jmp alltraps
801066cd:	e9 2d f8 ff ff       	jmp    80105eff <alltraps>
...
801066d4:	6a 53                	push   $0x53
  jmp alltraps
801066d6:	e9 24 f8 ff ff       	jmp    80105eff <alltraps>
...
801066dd:	6a 54                	push   $0x54
  jmp alltraps
801066df:	e9 1b f8 ff ff       	jmp    80105eff <alltraps>
...
801066e6:	6a 55                	push   $0x55
  jmp alltraps
801066e8:	e9 12 f8 ff ff       	jmp    80105eff <alltraps>
...
801066ef:	6a 56                	push   $0x56
  jmp alltraps
801066f1:	e9 09 f8 ff ff       	jmp    80105eff <alltraps>
...
801066f8:	6a 57                	push   $0x57
  jmp alltraps
801066fa:	e9 00 f8 ff ff       	jmp    80105eff <alltraps>
...
80106701:	6a 58                	push   $0x58
  jmp alltraps
80106703:	e9 f7 f7 ff ff       	jmp    80105eff <alltraps>
...
8010670a:	6a 59                	push   $0x59
  jmp alltraps
8010670c:	e9 ee f7 ff ff       	jmp    80105eff <alltraps>
...
80106713:	6a 5a                	push   $0x5a
  jmp alltraps
80106715:	e9 e5 f7 ff ff       	jmp    80105eff <alltraps>
...
8010671c:	6a 5b                	push   $0x5b
  jmp alltraps
8010671e:	e9 dc f7 ff ff       	jmp    80105eff <alltraps>
...
80106725:	6a 5c                	push   $0x5c
  jmp alltraps
80106727:	e9 d3 f7 ff ff       	jmp    80105eff <alltraps>
...
8010672e:	6a 5d                	push   $0x5d
  jmp alltraps
80106730:	e9 ca f7 ff ff       	jmp    80105eff <alltraps>
...
80106737:	6a 5e                	push   $0x5e
  jmp alltraps
80106739:	e9 c1 f7 ff ff       	jmp    80105eff <alltraps>
...
80106740:	6a 5f                	push   $0x5f
  jmp alltraps
80106742:	e9 b8 f7 ff ff       	jmp    80105eff <alltraps>
...
80106749:	6a 60                	push   $0x60
  jmp alltraps
8010674b:	e9 af f7 ff ff       	jmp    80105eff <alltraps>
...
80106752:	6a 61                	push   $0x61
  jmp alltraps
80106754:	e9 a6 f7 ff ff       	jmp    80105eff <alltraps>
...
8010675b:	6a 62                	push   $0x62
  jmp alltraps
8010675d:	e9 9d f7 ff ff       	jmp    80105eff <alltraps>
...
80106764:	6a 63                	push   $0x63
  jmp alltraps
80106766:	e9 94 f7 ff ff       	jmp    80105eff <alltraps>
...
8010676d:	6a 64                	push   $0x64
  jmp alltraps
8010676f:	e9 8b f7 ff ff       	jmp    80105eff <alltraps>
...
80106776:	6a 65                	push   $0x65
  jmp alltraps
80106778:	e9 82 f7 ff ff       	jmp    80105eff <alltraps>
...
8010677f:	6a 66                	push   $0x66
  jmp alltraps
80106781:	e9 79 f7 ff ff       	jmp    80105eff <alltraps>
...
80106788:	6a 67                	push   $0x67
  jmp alltraps
8010678a:	e9 70 f7 ff ff       	jmp    80105eff <alltraps>
...
80106791:	6a 68                	push   $0x68
  jmp alltraps
80106793:	e9 67 f7 ff ff       	jmp    80105eff <alltraps>
...
8010679a:	6a 69                	push   $0x69
  jmp alltraps
8010679c:	e9 5e f7 ff ff       	jmp    80105eff <alltraps>
...
801067a3:	6a 6a                	push   $0x6a
  jmp alltraps
801067a5:	e9 55 f7 ff ff       	jmp    80105eff <alltraps>
...
801067ac:	6a 6b                	push   $0x6b
  jmp alltraps
801067ae:	e9 4c f7 ff ff       	jmp    80105eff <alltraps>
...
801067b5:	6a 6c                	push   $0x6c
  jmp alltraps
801067b7:	e9 43 f7 ff ff       	jmp    80105eff <alltraps>
...
801067be:	6a 6d                	push   $0x6d
  jmp alltraps
801067c0:	e9 3a f7 ff ff       	jmp    80105eff <alltraps>
...
801067c7:	6a 6e                	push   $0x6e
  jmp alltraps
801067c9:	e9 31 f7 ff ff       	jmp    80105eff <alltraps>
...
801067d0:	6a 6f                	push   $0x6f
  jmp alltraps
801067d2:	e9 28 f7 ff ff       	jmp    80105eff <alltraps>
...
801067d9:	6a 70                	push   $0x70
  jmp alltraps
801067db:	e9 1f f7 ff ff       	jmp    80105eff <alltraps>
...
801067e2:	6a 71                	push   $0x71
  jmp alltraps
801067e4:	e9 16 f7 ff ff       	jmp    80105eff <alltraps>
...
801067eb:	6a 72                	push   $0x72
  jmp alltraps
801067ed:	e9 0d f7 ff ff       	jmp    80105eff <alltraps>
...
801067f4:	6a 73                	push   $0x73
  jmp alltraps
801067f6:	e9 04 f7 ff ff       	jmp    80105eff <alltraps>
...
801067fd:	6a 74                	push   $0x74
  jmp alltraps
801067ff:	e9 fb f6 ff ff       	jmp    80105eff <alltraps>
...
80106806:	6a 75                	push   $0x75
  jmp alltraps
80106808:	e9 f2 f6 ff ff       	jmp    80105eff <alltraps>
...
8010680f:	6a 76                	push   $0x76
  jmp alltraps
80106811:	e9 e9 f6 ff ff       	jmp    80105eff <alltraps>
...
80106818:	6a 77                	push   $0x77
  jmp alltraps
8010681a:	e9 e0 f6 ff ff       	jmp    80105eff <alltraps>
...
80106821:	6a 78                	push   $0x78
  jmp alltraps
80106823:	e9 d7 f6 ff ff       	jmp    80105eff <alltraps>
...
8010682a:	6a 79                	push   $0x79
  jmp alltraps
8010682c:	e9 ce f6 ff ff       	jmp    80105eff <alltraps>
...
80106833:	6a 7a                	push   $0x7a
  jmp alltraps
80106835:	e9 c5 f6 ff ff       	jmp    80105eff <alltraps>
...
8010683c:	6a 7b                	push   $0x7b
  jmp alltraps
8010683e:	e9 bc f6 ff ff       	jmp    80105eff <alltraps>
...
80106845:	6a 7c                	push   $0x7c
  jmp alltraps
80106847:	e9 b3 f6 ff ff       	jmp    80105eff <alltraps>
...
8010684e:	6a 7d                	push   $0x7d
  jmp alltraps
80106850:	e9 aa f6 ff ff       	jmp    80105eff <alltraps>
...
80106857:	6a 7e                	push   $0x7e
  jmp alltraps
80106859:	e9 a1 f6 ff ff       	jmp    80105eff <alltraps>
...
80106860:	6a 7f                	push   $0x7f
  jmp alltraps
80106862:	e9 98 f6 ff ff       	jmp    80105eff <alltraps>
...
80106875:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010687a:	e9 80 f6 ff ff       	jmp    80105eff <alltraps>
...
80106881:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106886:	e9 74 f6 ff ff       	jmp    80105eff <alltraps>
...
80106ef9:	e8 c2 b5 ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
80106f0f:	68 c6 7a 10 80       	push   $0x80107ac6
...
80106f9e:	e8 dd b6 ff ff       	call   80102680 <kalloc>
...
80106fb5:	e8 26 dc ff ff       	call   80104be0 <memset>
...
80106ffd:	68 b8 81 10 80       	push   $0x801081b8
...
80107013:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80107016:	e8 85 c9 ff ff       	call   801039a0 <cpuid>
  pd[0] = size-1;
...
8010702a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80107031:	ff 00 00 
80107034:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010703b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010703e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80107045:	ff 00 00 
80107048:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
8010704f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107052:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80107059:	ff 00 00 
8010705c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80107063:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107066:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
8010706d:	ff 00 00 
80107070:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80107077:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010707a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
801070a0:	a1 c4 94 11 80       	mov    0x801194c4,%eax
...
801070d4:	0f 84 c2 00 00 00    	je     8010719c <switchuvm+0xec>
  pushcli();
801070da:	e8 f1 d8 ff ff       	call   801049d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801070df:	e8 5c c8 ff ff       	call   80103940 <mycpu>
801070e4:	89 c3                	mov    %eax,%ebx
801070e6:	e8 55 c8 ff ff       	call   80103940 <mycpu>
801070eb:	89 c7                	mov    %eax,%edi
801070ed:	e8 4e c8 ff ff       	call   80103940 <mycpu>
801070f2:	83 c7 08             	add    $0x8,%edi
801070f5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801070f8:	e8 43 c8 ff ff       	call   80103940 <mycpu>
...
80107141:	e8 fa c7 ff ff       	call   80103940 <mycpu>
...
8010715f:	e8 dc c7 ff ff       	call   80103940 <mycpu>
80107164:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107167:	e8 d4 c7 ff ff       	call   80103940 <mycpu>
...
801071db:	77 4b                	ja     80107228 <inituvm+0x68>
  mem = kalloc();
801071dd:	e8 9e b4 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
801071ef:	e8 ec d9 ff ff       	call   80104be0 <memset>
...
80107222:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107223:	e9 58 da ff ff       	jmp    80104c80 <memmove>
    panic("inituvm: more than a page");
80107228:	83 ec 0c             	sub    $0xc,%esp
8010722b:	68 fd 81 10 80       	push   $0x801081fd
...
80107290:	68 17 82 10 80       	push   $0x80108217
...
801072de:	e8 ad a7 ff ff       	call   80101a90 <readi>
...
80107318:	68 b8 82 10 80       	push   $0x801082b8
...
8010737b:	e8 60 d8 ff ff       	call   80104be0 <memset>
...
801073ab:	e8 d0 b2 ff ff       	call   80102680 <kalloc>
...
801073b9:	68 35 82 10 80       	push   $0x80108235
...
8010741b:	68 4d 82 10 80       	push   $0x8010824d
...
80107440:	e8 7b b0 ff ff       	call   801024c0 <kfree>
      return 0;
...
801074de:	e8 dd af ff ff       	call   801024c0 <kfree>
...
801074f3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801074f4:	e9 c7 af ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
801074f9:	83 ec 0c             	sub    $0xc,%esp
801074fc:	68 69 82 10 80       	push   $0x80108269
...
80107515:	e8 66 b1 ff ff       	call   80102680 <kalloc>
...
8010759b:	a3 c4 94 11 80       	mov    %eax,0x801194c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801075cc:	68 7a 82 10 80       	push   $0x8010827a
...
80107642:	68 84 82 10 80       	push   $0x80108284
...
801076a0:	e8 db d5 ff ff       	call   80104c80 <memmove>
...
801076ec:	e8 cf ad ff ff       	call   801024c0 <kfree>
      goto bad;
...
80107717:	68 9e 82 10 80       	push   $0x8010829e
...
801077d0:	e8 ab d4 ff ff       	call   80104c80 <memmove>
    len -= n;
    buf += n;
