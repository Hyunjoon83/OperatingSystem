   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  19:	6a 01                	push   $0x1
  1b:	e8 a0 04 00 00       	call   4c0 <printf>
  20:	83 c4 10             	add    $0x10,%esp
    thread_create(&thread[i], thread_main, (void *)i);
  23:	83 ec 04             	sub    $0x4,%esp
  26:	8d 04 9d 7c 0b 00 00 	lea    0xb7c(,%ebx,4),%eax
  2d:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
  ...
  36:	50                   	push   %eax
  37:	e8 a7 03 00 00       	call   3e3 <thread_create>
  for (i = 0; i < NUM_THREAD; i++) {
  ...
  4c:	e8 82 03 00 00       	call   3d3 <sleep>
  ...
  exit();
  5f:	e8 df 02 00 00       	call   343 <exit>
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
...
00000070 <thread_main>:
{
  ...
  96:	e8 38 03 00 00       	call   3d3 <sleep>
  9b:	83 c4 10             	add    $0x10,%esp
  printf(1, "This code shouldn't be executed!!\n");
  9e:	83 ec 08             	sub    $0x8,%esp
  a1:	68 30 08 00 00       	push   $0x830
  a6:	6a 01                	push   $0x1
  ...
  b5:	6a 64                	push   $0x64
  b7:	e8 17 03 00 00       	call   3d3 <sleep>
    printf(1, "Executing...\n");
  bc:	58                   	pop    %eax
  bd:	5a                   	pop    %edx
  be:	68 07 08 00 00       	push   $0x807
  c3:	6a 01                	push   $0x1
    char *args[2] = {pname, 0};
  c5:	c7 45 f0 f9 07 00 00 	movl   $0x7f9,-0x10(%ebp)
  ...
  dc:	5b                   	pop    %ebx
  dd:	50                   	push   %eax
  de:	68 f9 07 00 00       	push   $0x7f9
  e3:	e8 93 02 00 00       	call   37b <exec>
...
free(void *ap)
{
 ...
 661:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 90 0b 00 00    	mov    %edx,0xb90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 90 0b 00 00    	mov    0xb90,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 7d2:	00 00 00 
    if(p->s.size >= nunits){
