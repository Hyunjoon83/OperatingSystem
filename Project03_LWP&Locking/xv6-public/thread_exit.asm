   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  14:	68 e5 07 00 00       	push   $0x7e5
  19:	6a 01                	push   $0x1
  1b:	e8 80 04 00 00       	call   4a0 <printf>
  20:	83 c4 10             	add    $0x10,%esp
    thread_create(&thread[i], thread_main, (void *)i);
  23:	83 ec 04             	sub    $0x4,%esp
  26:	8d 04 9d 4c 0b 00 00 	lea    0xb4c(,%ebx,4),%eax
  2d:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
  2e:	83 c3 01             	add    $0x1,%ebx
    thread_create(&thread[i], thread_main, (void *)i);
  31:	68 70 00 00 00       	push   $0x70
  36:	50                   	push   %eax
  37:	e8 87 03 00 00       	call   3c3 <thread_create>
  for (i = 0; i < NUM_THREAD; i++) {
  3c:	83 c4 10             	add    $0x10,%esp
  3f:	83 fb 05             	cmp    $0x5,%ebx
  42:	75 df                	jne    23 <main+0x23>
  }
  sleep(200);
  44:	83 ec 0c             	sub    $0xc,%esp
  47:	68 c8 00 00 00       	push   $0xc8
  4c:	e8 62 03 00 00       	call   3b3 <sleep>
  ...
  exit();
  5f:	e8 bf 02 00 00       	call   323 <exit>
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
...
00000070 <thread_main>:
{
  ...
  96:	e8 18 03 00 00       	call   3b3 <sleep>
  printf(1, "This code shouldn't be executed!!\n");
  9b:	58                   	pop    %eax
  9c:	5a                   	pop    %edx
  9d:	68 00 08 00 00       	push   $0x800
  a2:	6a 01                	push   $0x1
  a4:	e8 f7 03 00 00       	call   4a0 <printf>
  exit();
  a9:	e8 75 02 00 00       	call   323 <exit>
    sleep(100);
  ae:	83 ec 0c             	sub    $0xc,%esp
  b1:	6a 64                	push   $0x64
  b3:	e8 fb 02 00 00       	call   3b3 <sleep>
    printf(1, "Exiting...\n");
  b8:	59                   	pop    %ecx
  b9:	5b                   	pop    %ebx
  ...
  c1:	e8 da 03 00 00       	call   4a0 <printf>
    exit();
  c6:	e8 58 02 00 00       	call   323 <exit>
  cb:	66 90                	xchg   %ax,%ax
  cd:	66 90                	xchg   %ax,%ax
  cf:	90                   	nop
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 2c 08 00 00 	jmp    *0x82c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 23 08 00 00       	mov    $0x823,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 7b2:	00 00 00 
    if(p->s.size >= nunits){
