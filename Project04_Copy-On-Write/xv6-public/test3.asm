  ...
  10:	31 db                	xor    %ebx,%ebx
{
  ...
  int parent_initial_fp = countfp();
  22:	e8 cc 03 00 00       	call   3f3 <countfp>
  27:	83 c4 10             	add    $0x10,%esp
  2a:	89 c6                	mov    %eax,%esi
  for(int i = 0; i < 10; i++){
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pid = fork();
  30:	e8 16 03 00 00       	call   34b <fork>
    if(pid == 0){
  35:	85 c0                	test   %eax,%eax
  37:	74 6e                	je     a7 <main+0xa7>
  for(int i = 0; i < 10; i++){
  ...
  for(int i = 0; i < 10; i++){
    wait();
  48:	e8 0e 03 00 00       	call   35b <wait>
  for(int i = 0; i < 10; i++){
  ...
  52:	e8 9c 03 00 00       	call   3f3 <countfp>
  57:	39 f0                	cmp    %esi,%eax
  59:	74 39                	je     94 <main+0x94>
    printf(1,"parent initial fp: %d\n", parent_initial_fp);
  5b:	52                   	push   %edx
  5c:	56                   	push   %esi
  5d:	68 37 08 00 00       	push   $0x837
  62:	6a 01                	push   $0x1
  64:	e8 67 04 00 00       	call   4d0 <printf>
    printf(1,"parent final fp: %d\n", countfp());
  69:	e8 85 03 00 00       	call   3f3 <countfp>
  6e:	83 c4 0c             	add    $0xc,%esp
  71:	50                   	push   %eax
  72:	68 4e 08 00 00       	push   $0x84e
  77:	6a 01                	push   $0x1
  ...
  8c:	83 c4 10             	add    $0x10,%esp
      exit();
  8f:	e8 bf 02 00 00       	call   353 <exit>
  }else
    printf(1, "[Test 3] pass\n\n");
  94:	50                   	push   %eax
  95:	50                   	push   %eax
  96:	68 63 08 00 00       	push   $0x863
  9b:	6a 01                	push   $0x1
  9d:	e8 2e 04 00 00       	call   4d0 <printf>
  a2:	83 c4 10             	add    $0x10,%esp
  a5:	eb e8                	jmp    8f <main+0x8f>
      sleep(100 + 50 * i);
  a7:	6b c3 32             	imul   $0x32,%ebx,%eax
  aa:	83 ec 0c             	sub    $0xc,%esp
  ad:	83 c0 64             	add    $0x64,%eax
  b0:	50                   	push   %eax
  b1:	e8 2d 03 00 00       	call   3e3 <sleep>
      int child_initial_fp = countfp();
  b6:	e8 38 03 00 00       	call   3f3 <countfp>
      initial_data = 1;
  bb:	c7 05 8c 0b 00 00 01 	movl   $0x1,0xb8c
  c2:	00 00 00 
      int child_initial_fp = countfp();
  c5:	89 c7                	mov    %eax,%edi
      int child_modified_fp = countfp();
  c7:	e8 27 03 00 00       	call   3f3 <countfp>
  cc:	89 c6                	mov    %eax,%esi
      printf(1, "child [%d]'s result: %d\n", i,child_initial_fp - child_modified_fp);
  ce:	89 f8                	mov    %edi,%eax
  d0:	29 f0                	sub    %esi,%eax
  d2:	50                   	push   %eax
  d3:	53                   	push   %ebx
  d4:	68 0e 08 00 00       	push   $0x80e
  d9:	6a 01                	push   $0x1
  db:	e8 f0 03 00 00       	call   4d0 <printf>
      if((child_initial_fp - child_modified_fp) == 0)
  e0:	83 c4 20             	add    $0x20,%esp
  e3:	39 f7                	cmp    %esi,%edi
  e5:	75 a8                	jne    8f <main+0x8f>
        printf(1, "[Test 3] fail\n\n");
  e7:	56                   	push   %esi
  e8:	56                   	push   %esi
  e9:	68 27 08 00 00       	push   $0x827
  ee:	6a 01                	push   $0x1
  f0:	e8 db 03 00 00       	call   4d0 <printf>
  f5:	83 c4 10             	add    $0x10,%esp
  f8:	eb 95                	jmp    8f <main+0x8f>
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
  fe:	66 90                	xchg   %ax,%ax
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 7c 08 00 00 	jmp    *0x87c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 73 08 00 00       	mov    $0x873,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 90 0b 00 00    	mov    %edx,0xb90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 90 0b 00 00    	mov    0xb90,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 7e2:	00 00 00 
    if(p->s.size >= nunits){
